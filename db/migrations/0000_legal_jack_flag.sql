...
CREATE TABLE IF NOT EXISTS "film" (
	...
	"tmdb_id" varchar(256) NOT NULL,
	CONSTRAINT "film_tmdb_id_unique" UNIQUE("tmdb_id")
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "like" ADD CONSTRAINT "like_film_id_film_tmdb_id_fk" FOREIGN KEY ("film_id") REFERENCES "public"."film"("tmdb_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "film_index" ON "film" USING btree ("tmdb_id");--> statement-breakpoint
